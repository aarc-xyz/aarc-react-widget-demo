...
import { WagmiAppConnector } from "./Wagmi/WagmiConnector"
...
function App() {
    ...
    const [selectedConnector, setSelectedConnector] =
        useState<WalletConnectorType>(WalletConnectorType.ETH)
                        ...
                        <div className="form">
                            <div className="form-item">
                                <label>
                                    ...
                                    >
                                        <option value={WalletConnectorType.ETH}>
                                            Ethereum Wallet
                                        </option>
                                        <option
                                            value={WalletConnectorType.THIRDWEB}
                                        >
                                            Thirdweb Wallet
                                        </option>
                                        <option
                                            value={WalletConnectorType.WAGMI}
                                        >
                                            Wagmi Wallet
                                        </option>
                                    </select>
                            ...
                            {selectedConnector === WalletConnectorType.ETH && (
                                <AarcEthWalletConnector
                                    aarcWebClient={aarcModal}
                                />
                            )}
                            {selectedConnector ===
                                WalletConnectorType.THIRDWEB && (
                                <ThirdwebAppConnector aarcClient={aarcModal} />
                            )}
                            {selectedConnector ===
                                WalletConnectorType.WAGMI && (
                                <WagmiAppConnector aarcClient={aarcModal} />
                            )}
                            <div className="form-item">
                                <label>
                            ...
                            <div className="buttons">
                                ...
                                <button
                                    onClick={async () => {
                                        ...
                                        aarcModal.updateRequestedAmountInUSD(
                                            0.01
                                        )
                                        aarcModal.openModal()
                                    }}
                                ...
                                <button
                                    onClick={async () => {
                                        setAddress(
                                            config.destination.walletAddress
                                        )
                                        aarcModal.reset()
                                        aarcModal.openModal()
                                    }}
